...
public class Row implements Serializable {
  ...
  //if rowPos is -1, the row is in memory and it contains key and values
  //if rowPos is positive, the row is in disk and it contains only key and rowPos in the file
  protected long rowPos;
  ...
  public Row(String keyArg, long rowPosArg) {
    key = keyArg;
    values = new HashMap<String,byte[]>();
    rowPos = rowPosArg;
  }
